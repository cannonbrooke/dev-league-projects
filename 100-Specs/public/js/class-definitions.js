 ...
 */
 ...
 //  var length = linuxFlavors.length;
 //  for(var i = 0; i < length; i++){
 //    if (linuxFlavors.indexOf(linuxFlavors) > -1){
 //      return true
 //    }
 //  }
 //    return false
...
return ("<ul>" + "<li>" + livingOrganismClassification.join("</li>" + "<li>") + "</ul>");
}
 ...
 *
 */
function Person(name,money,age,gender){ //class defined
  this.name = name;
  this.money = money;
  this.age = age;
  this.gender = gender;
...
Person.prototype.spendMoney = function(spendDatShit){ //this is a method
  this.money = this.money - spendDatShit;

};

Person.prototype.earnMoney = function(spendDatShit){ //method
  this.money = this.money + spendDatShit;
};
...
var shortStory = new House(1).isATallStory(2);
